    ...
    async rewrites() {
        return [
            ...
            },
            {
                ...
                destination: 'http://' + process.env.NEXT_PUBLIC_BACKEND_URL + '/api/archive/hikes/:id/file/report',
            },
            {
                source: '/hikes/:id/route',
                destination: 'http://' + process.env.NEXT_PUBLIC_BACKEND_URL + '/api/archive/hikes/:id/file/route',
            },
        ];
    },
};
