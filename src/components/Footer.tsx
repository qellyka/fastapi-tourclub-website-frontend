...
const VkontakteIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-6 h-6 transform scale-110" fill="currentColor" viewBox="0 0 32 32">
...
export default function Footer() {
  const socialLinks = [
    { href: 'https://vk.com/tk_irbis', icon: <VkontakteIcon /> },
    { href: 'https://t.me/irbis_30', icon: <Send size={20} /> },
    { href: 'https://www.youtube.com/@irbis30', icon: <Youtube size={20} /> },
    { href: 'https://www.instagram.com/irbis_30/', icon: <Instagram size={20} /> },
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} Турклуб &quot;Ирбис&quot;. Все права защищены.</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map(link => (
              <SocialIcon key={link.href} href={link.href}>
                {link.icon}
              </SocialIcon>
            ))}
          </div>
